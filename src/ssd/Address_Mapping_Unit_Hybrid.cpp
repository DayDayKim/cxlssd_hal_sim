...
int Address_Mapping_Unit_Hybrid::Bring_to_CMT_for_preconditioning(stream_id_type stream_id, LPA_type lpa)
{
    return 0;
}
unsigned int Address_Mapping_Unit_Hybrid::Get_cmt_capacity()
{
    return 0;
}
unsigned int Address_Mapping_Unit_Hybrid::Get_current_cmt_occupancy_for_stream(stream_id_type stream_id)
{
    return 0;
}
int Address_Mapping_Unit_Hybrid::Translate_lpa_to_ppa_and_dispatch(std::list<NVM_Transaction*>& transaction_list, User_Request* user_request, unsigned int* back_pressure_buffer_depth)
{
    return 0;
}
...
PPA_type Address_Mapping_Unit_Hybrid::online_create_entry_for_reads(LPA_type lpa, const stream_id_type stream_id, NVM::FlashMemory::Physical_Page_Address& read_address, uint64_t read_sectors_bitmap)
{
    return 0;
}
...
PPA_type Address_Mapping_Unit_Hybrid::Convert_address_to_ppa(const NVM::FlashMemory::Physical_Page_Address& pageAddress)
{
    return 0;
}
...
bool Address_Mapping_Unit_Hybrid::is_lpa_locked_for_gc(stream_id_type stream_id, LPA_type lpa)
{
    return false;
}
bool Address_Mapping_Unit_Hybrid::is_mvpn_locked_for_gc(stream_id_type stream_id, MVPN_type mvpn)
{
    return false;
}
...
int Address_Mapping_Unit_Hybrid::Start_servicing_writes_for_overfull()
{
    return 0;
}
}
